...
function renderSummary(data: ShowcaseData, indent: string): string[] {
  ...
  lines.push(`${indent}  - ${yamlValue(`AI agent team of **${agentCount} agents**, processing **${totalTokens} tokens** across **${sessions} sessions** from ${since} to ${until}. Total cost: **${cost}**. Generated by [@eat-pray-ai/wingman](https://www.npmjs.com/package/@eat-pray-ai/wingman).`)}`);
  return lines;
}
